package com.azhar.spks.database;
...
import com.azhar.spks.model.ModelDaftarPenyakit;
    ...
    public ArrayList<ModelKonsultasi> getDaftarGejala() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                modelDraftOffline.setKodeGejala(cursor.getString(0));
                modelDraftOffline.setStrGejala(cursor.getString(1));
                draftOffline.add(modelDraftOffline);
            } while (cursor.moveToNext());
        }
        cursor.close();
