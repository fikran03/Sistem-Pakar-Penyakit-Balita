...
import com.azhar.spks.adapter.KonsultasiAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnHasilDiagnosa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                StringBuffer kodegej = new StringBuffer();
                ...
                for (int i = 0; i < gejalaList.size(); i++) {
                    ...
                    if (gejala.isSelected()) {
                        kodegej.append(gejala.getKodeGejala()).append(",");
                ...
                if (gejalaTerpilih.toString().equals("")) {
                    ...
                    intent.putExtra("KODE", kodegej.toString());
